"""
Tests de unicidad de permisos en el sistema de roles.

Verifica que el sistema de permisos basado en roles funcione correctamente
asegurando que cada usuario tenga solo los permisos correspondientes a sus roles.
"""
...
class PermissionTests(TestCase):
    """Tests para verificar la unicidad y correcta asignación de permisos."""

    def setUp(self):
        """Configura roles, permisos y usuarios para los tests."""
