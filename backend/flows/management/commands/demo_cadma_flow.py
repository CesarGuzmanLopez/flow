...
from flows.application.flow_engine import FlowEngine
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS("Demo CADMA flow created successfully"))
